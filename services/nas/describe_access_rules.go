...
type DescribeAccessRulesResponse struct {
	*responses.BaseResponse
	...
	AccessRules DescribeAccessRules_AccessRules `json:"AccessRules" xml:"AccessRules"`
}

type DescribeAccessRules_AccessRules struct {
	AccessRule []DescribeAccessRules_AccessRule `json:"AccessRule" xml:"AccessRule"`
}

type DescribeAccessRules_AccessRule struct {
