...
type DescribeAccessGroupsResponse struct {
	*responses.BaseResponse
	...
	AccessGroups DescribeAccessGroups_AccessGroups `json:"AccessGroups" xml:"AccessGroups"`
}

type DescribeAccessGroups_AccessGroups struct {
	AccessGroup []DescribeAccessGroups_AccessGroup `json:"AccessGroup" xml:"AccessGroup"`
}

type DescribeAccessGroups_AccessGroup struct {
